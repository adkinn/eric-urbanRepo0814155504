...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: e7495e48-a600-44ff-8224-0ccf9f9e6f99
  ...
  \<xs:complexContent mixed="false">
    \<xs:extension base="tns:ReportRequest">
      \<xs:sequence>
        ...
        \<xs:element name="Columns" type="tns:ArrayOfAudiencePerformanceReportColumn" nillable="true"/>
        \<xs:element name="Filter" type="tns:AudiencePerformanceReportFilter" nillable="true" minOccurs="0"/>
...
|*Columns*|The list of attributes and performance statistics to include in the report. The report will include the columns in the order that you specify them.|[AudiencePerformanceReportColumn](../reporting-api/audienceperformancereportcolumn-value-set.md) array|Required|
|*Filter*|The filter information to use to filter the report data.|[AudiencePerformanceReportFilter](../reporting-api/audienceperformancereportfilter-data-object.md)|Optional|
