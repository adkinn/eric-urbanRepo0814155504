...
[!INCLUDE[brand](../api-reference/includes/brand.md)] service operations may return error codes depending on the context. The list provided below includes error codes across all [!INCLUDE[brand](../api-reference/includes/brand.md)] services. For information about error codes per service operation, see the reference page for each operation.
...
**Description**
An unidentified error has occurred. You may obtain additional information about this error by contacting [!INCLUDE[brand](../api-reference/includes/brand.md)] Support.
...
**Description**
We have detected suspicious activity on your [!INCLUDE[brand](../api-reference/includes/brand.md)] account. We think someone may have logged into your [!INCLUDE[brand](../api-reference/includes/brand.md)] account without your permission. Please create a new password to secure your account.
...
**Description**
The time zone value is not valid. See [Time Zones](../api-reference/time-zones.md) for list of valid time zone values.
...
**Note:** For a list of editorial reason codes, see [Bing Ads Editorial Failure Reason Codes](../api-reference/bing-ads-editorial-failure-reason-codes.md).
...
**Description**
The [!INCLUDE[storebrand](../api-reference/includes/storebrand.md)] store identifier is invalid.
