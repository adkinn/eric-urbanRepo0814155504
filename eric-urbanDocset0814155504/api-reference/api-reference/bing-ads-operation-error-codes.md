...
For more information about error handling and troubleshooting, see [Handling Service Errors and Exceptions](../Topic/Handling%20Service%20Errors%20and%20Exceptions.md).
...
**Description**
Authentication token expired. Please renew it or obtain a new token. For more information, see [Authentication with OAuth](../Topic/Authentication%20with%20OAuth.md).
