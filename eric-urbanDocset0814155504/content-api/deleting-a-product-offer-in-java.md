...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 1074fb24-eebc-4dcf-b0bd-b0628f7f82d5
caps.latest.revision: 3
author: "eric-urban"
ms.author: "scottwhi"
---
# Deleting a Product Offer in Java
This example shows how to delete a single product offer using Java. For information about deleting product offers, see [Deleting a product offer from the store](../content-api/managing-your-products.md#delete).
