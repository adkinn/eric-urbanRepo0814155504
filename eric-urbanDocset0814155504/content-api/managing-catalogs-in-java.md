...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 6e325fde-6c89-4d24-831d-448da4d0579a
caps.latest.revision: 3
author: "eric-urban"
ms.author: "scottwhi"
---
# Managing Catalogs in Java
This example shows how to manage your store's catalogs using Java. For information about the catalog-related classes used by this example, see [Catalogs](../content-api/catalogs-resource.md#catalogs) and [Catalog](../content-api/catalogs-resource.md#catalog). For information about working with catalogs, see [Managing your Catalogs](../content-api/managing-your-catalogs.md).
