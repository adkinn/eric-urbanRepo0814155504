...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: e7b0130e-2f17-4c62-a3d6-b4680ad43be1
caps.latest.revision: 6
author: "eric-urban"
ms.author: "scottwhi"
---
# Getting a List of Product Offers in Java
This example shows how to get a list of product offers from the store using Java. For information about the product-related classes used by this example, see [Products](../content-api/products-resource.md#products) and [Product](../content-api/products-resource.md#product). For information about getting a list of products, see [Getting a list of product offers from the store](../content-api/managing-your-products.md#list).
