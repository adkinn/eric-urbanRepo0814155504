...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 43a0b5ae-a8f6-49d5-8e68-9a05f3c89201
caps.latest.revision: 6
author: "eric-urban"
ms.author: "scottwhi"
---
# Inserting a Product Offer in Java
This example shows how to insert a product offer into a catalog using Java. For information about the class used by this example, see [Product](../content-api/products-resource.md#product). For information about inserting products, see [Adding and updating a product offer](../content-api/managing-your-products.md#insert).
