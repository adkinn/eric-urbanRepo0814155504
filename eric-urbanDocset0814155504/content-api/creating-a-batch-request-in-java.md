...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 2400c0bf-e549-4af1-a679-98ced5547309
caps.latest.revision: 7
author: "eric-urban"
ms.author: "scottwhi"
---
# Creating a Batch Request in Java
This example shows how to create a batch request that can contain thousands of insert, get, and delete operations using Java. For information about the batch-related classes used by this example, see [Batch](../content-api/products-resource.md#batch), [Item](../content-api/products-resource.md#item), and [BatchItemError](../content-api/products-resource.md#batchitemerror). For information about using the batch feature, see [Using batch processing](../content-api/managing-your-products.md#batch).
