...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: fffb0011-9936-4d09-b8db-8775e6884e13
caps.latest.revision: 3
author: "eric-urban"
ms.author: "scottwhi"
---
# Downloading a Catalog Status Report in Java
This example shows how to get a report that shows whether products were successfully added to the catalog. For information about the class used by this example, see [Status](../content-api/status-resource.md#status). For information about getting the report, see [How Do I Get the Status of Product Offers?](../content-api/how-do-i-get-the-status-of-product-offers.md)
