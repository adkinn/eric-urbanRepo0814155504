...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 0e1e9dba-d0f4-4bbc-8c9a-e77acea743cf
caps.latest.revision: 3
author: "eric-urban"
ms.author: "scottwhi"
---
# Getting a Product Offer in Java
This example shows how to get a single product offer using Java. For information about the class used by this example, see [Product](../content-api/products-resource.md#product). For information about getting product offers, see [Getting a product offer from the store](../content-api/managing-your-products.md#get).
