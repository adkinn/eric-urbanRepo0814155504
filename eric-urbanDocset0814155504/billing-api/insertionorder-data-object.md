...
|*BookingCountryCode*|A code that identifies the country/region in which the account operates. For a list of country code values, see [Geographical Location Codes](https://msdn.microsoft.com/library/bing-ads-geographical-location-codes.aspx).<br /><br />You cannot update the country code after the insertion order becomes active.<br/><br/>**Add:** Required<br/>**Update:** Read-only|*string*|
