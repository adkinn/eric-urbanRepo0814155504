...
This example shows how to apply product conditions for [!INCLUDE[brand_bsc](../Bing Ads API Overview/includes/brand-bsc.md)] using the following Campaign Management service operations.
