...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: aa73ad94-8339-4601-b0e4-537b15d1502b
...
The following example shows how to add targets using the *BulkServiceManager* class provided with the [Bing Ads Client Libraries](../Bing Ads API Overview/bing-ads-client-libraries.md).
