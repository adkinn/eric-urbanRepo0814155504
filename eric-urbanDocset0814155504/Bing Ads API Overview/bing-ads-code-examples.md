...
Get started developing Bing Ads applications in any programming language which supports web services, and some samples are provided in the following sections.
...
-   [Python Examples for Bing Ads](../Bing Ads API Overview/python-examples-for-bing-ads.md)
