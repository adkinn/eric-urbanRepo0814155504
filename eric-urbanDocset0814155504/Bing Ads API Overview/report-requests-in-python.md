---
title: "Report Requests in Python"
ms.custom: ""
ms.date: "08/16/2017"
ms.reviewer: ""
ms.suite: ""
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: ec648c81-aef0-4447-bb23-1b91841cc4eb
caps.latest.revision: 4
author: "eric-urban"
ms.author: "eur"
manager: "ehansen"
---
# Report Requests in Python
The following code example shows how to request and retrieve a keyword performance report using the *ReportingServiceManager* class provided with the [Bing Ads Client Libraries](../Bing Ads API Overview/bing-ads-client-libraries.md).

[!INCLUDE[python_header](../Bing Ads API Overview/includes/python-header.md)]
