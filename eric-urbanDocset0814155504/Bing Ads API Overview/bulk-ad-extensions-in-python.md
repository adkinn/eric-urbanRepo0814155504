---
title: "Bulk Ad Extensions in Python"
ms.custom: ""
ms.date: "08/16/2017"
ms.reviewer: ""
ms.suite: ""
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 33be6277-8071-4dd4-8921-2c13b0f7eb37
caps.latest.revision: 4
author: "eric-urban"
ms.author: "eur"
manager: "ehansen"
---
# Bulk Ad Extensions in Python
The following example shows how to add and update ad extensions using the *BulkServiceManager* class provided with the [Bing Ads Client Libraries](../Bing Ads API Overview/bing-ads-client-libraries.md).
