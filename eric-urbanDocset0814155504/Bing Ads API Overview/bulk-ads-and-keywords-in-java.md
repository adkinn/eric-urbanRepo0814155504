...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 5820e572-d6ca-40e8-af06-ac0136db3b98
...
The following example shows how to add ads and keywords to a new ad group using the *BulkServiceManager* class provided with the [Bing Ads Client Libraries](../Bing Ads API Overview/bing-ads-client-libraries.md).
