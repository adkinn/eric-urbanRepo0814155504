...
1.  Set up the development environment as described in [Getting Started Using Java with Bing Ads Services](../Bing Ads API Overview/getting-started-using-java-with-bing-ads-services.md). 
