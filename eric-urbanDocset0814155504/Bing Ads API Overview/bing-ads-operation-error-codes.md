...
[!INCLUDE[brand](../Bing Ads API Overview/includes/brand.md)] service operations may return error codes depending on the context. The list provided below includes error codes across all [!INCLUDE[brand](../Bing Ads API Overview/includes/brand.md)] services. For information about error codes per service operation, see the reference page for each operation.

For more information about error handling and troubleshooting, see [Handling Service Errors and Exceptions](../Bing Ads API Overview/handling-service-errors-and-exceptions.md).
...
The *BatchError* and *OperationError* objects for [Customer Billing](https://msdn.microsoft.com/library/bing-ads-customer-billing-service-reference.aspx) and [Customer Management](https://msdn.microsoft.com/library/bing-ads-customer-management-service-reference.aspx) services do not contain the *ErrorCode* element. The corresponding **Symbolic Error Code** table entries below are noted as **Not applicable**.
...
**Description**
An unidentified error has occurred. You may obtain additional information about this error by contacting [!INCLUDE[brand](../Bing Ads API Overview/includes/brand.md)] Support.
...
**Description**
We have detected suspicious activity on your [!INCLUDE[brand](../Bing Ads API Overview/includes/brand.md)] account. We think someone may have logged into your [!INCLUDE[brand](../Bing Ads API Overview/includes/brand.md)] account without your permission. Please create a new password to secure your account.
...
**Description**
Authentication token expired. Please renew it or obtain a new token. For more information, see [Authentication with OAuth](../Bing Ads API Overview/authentication-with-oauth.md).
...
**Description**
The time zone value is not valid. See [Time Zones](../Bing Ads API Overview/time-zones.md) for list of valid time zone values.
...
**Note:** For a list of editorial reason codes, see [Bing Ads Editorial Failure Reason Codes](../Bing Ads API Overview/bing-ads-editorial-failure-reason-codes.md).
...
**Description**
The campaigns included in the download have more keywords than allowed per request. Please call [DownloadCampaignsByCampaignIds](https://msdn.microsoft.com/library/bing-ads-bulk-downloadcampaignsbycampaignids.aspx) with fewer campaigns.

**Note:** Calling the [DownloadCampaignsByCampaignIds](https://msdn.microsoft.com/library/bing-ads-bulk-downloadcampaignsbycampaignids.aspx) operation with an account that contains more than eight million keywords will fail.
...
**Description**
The [!INCLUDE[storebrand](../Bing Ads API Overview/includes/storebrand.md)] store identifier is invalid.
...
**Note:** This error may be thrown during a call to the [AddMedia](https://msdn.microsoft.com/library/bing-ads-campaign-management-addmedia.aspx) operation if either the media *Type* or *MediaType* is invalid.
