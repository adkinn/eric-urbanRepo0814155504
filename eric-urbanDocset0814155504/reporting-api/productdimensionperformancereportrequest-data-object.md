...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 45a268b3-be4d-4756-9bab-16c1dc942d04
...
|*Columns*|The list of attributes and performance statistics to include in the report. The report will include the columns in the order that you specify them.|[ProductDimensionPerformanceReportColumn](../reporting-api/productdimensionperformancereportcolumn-value-set.md) array|Required|
|*Filter*|The filter information to use to filter the report data.|[ProductDimensionPerformanceReportFilter](../reporting-api/productdimensionperformancereportfilter-data-object.md)|Optional|
