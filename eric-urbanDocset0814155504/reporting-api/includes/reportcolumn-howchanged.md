The value that indicates whether the element was added, updated, or deleted. For possible values, see [ChangeTypeReportFilter Value Set](../../reporting-api/changetypereportfilter-value-set.md).
