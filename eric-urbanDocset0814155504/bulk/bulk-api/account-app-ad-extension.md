...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: d2a42751-5925-4ae4-88a6-b17268147bec
...
Defines an association record between an [Account](../bulk-api/account.md) and an [App Ad Extension](../bulk-api/app-ad-extension.md) that can be uploaded and downloaded in a bulk file. To upload or download the account or app ad extension, use the [Account](../bulk-api/account.md) or [App Ad Extension](../bulk-api/app-ad-extension.md) record.

> [!NOTE]
> [!INCLUDE[pilot_comingsoon](../bulk-api/includes/pilot-comingsoon.md)]
	
## <a name="entitydata"></a>Attribute Fields in the Bulk File
For a *Account App Ad Extension* record, the following attribute fields are available in the [Bulk File Schema](../bulk-api/bulk-file-schema.md). 
...
If you are using the [Bing Ads SDKs](https://msdn.microsoft.com/library/bing-ads-client-libraries.aspx) for .NET, Java, or Python, you can save time using the *BulkServiceManager* to upload and download the *BulkAccountAppAdExtension* class, instead of calling the service operations directly and writing custom code to parse each field in the bulk file. 
