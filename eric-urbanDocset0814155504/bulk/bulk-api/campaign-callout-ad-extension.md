...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: ac7d82c9-2764-4a0b-93e5-015b05091bba
...
Defines an association record between a [Campaign](../bulk-api/campaign.md) and an [Callout Ad Extension](../bulk-api/callout-ad-extension.md) that can be uploaded and downloaded in a bulk file. To upload or download the campaign or callout ad extension, use the [Campaign](../bulk-api/campaign.md) or [Callout Ad Extension](../bulk-api/callout-ad-extension.md) record.
	
## <a name="entitydata"></a>Attribute Fields in the Bulk File
For a *Campaign Callout Ad Extension* record, the following attribute fields are available in the [Bulk File Schema](../bulk-api/bulk-file-schema.md). 
...
If you are using the [Bing Ads SDKs](https://msdn.microsoft.com/library/bing-ads-client-libraries.aspx) for .NET, Java, or Python, you can save time using the *BulkServiceManager* to upload and download the *BulkCampaignCalloutAdExtension* class, instead of calling the service operations directly and writing custom code to parse each field in the bulk file. 
