...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: b6432bd6-2d74-4bdd-929f-e595663225ca
...
Defines an association record between an [Ad Group](../bulk-api/ad-group.md) and an [App Ad Extension](../bulk-api/app-ad-extension.md) that can be uploaded and downloaded in a bulk file. To upload or download the ad group or app ad extension, use the [Ad Group](../bulk-api/ad-group.md) or [App Ad Extension](../bulk-api/app-ad-extension.md) record.
	
## <a name="entitydata"></a>Attribute Fields in the Bulk File
For an *Ad Group App Ad Extension* record, the following attribute fields are available in the [Bulk File Schema](../bulk-api/bulk-file-schema.md). 
...
If you are using the [Bing Ads SDKs](https://msdn.microsoft.com/library/bing-ads-client-libraries.aspx) for .NET, Java, or Python, you can save time using the *BulkServiceManager* to upload and download the *BulkAdGroupAppAdExtension* class, instead of calling the service operations directly and writing custom code to parse each field in the bulk file. 
