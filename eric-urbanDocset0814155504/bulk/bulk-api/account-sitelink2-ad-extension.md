...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 51b054e1-1b17-432c-99f8-9801ab40a96a
...
Defines an association record between an [Account](../bulk-api/account.md) and a [Sitelink2 Ad Extension](../bulk-api/sitelink2-ad-extension.md) that can be uploaded and downloaded in a bulk file. To upload or download the account or sitelink2 ad extension, use the [Account](../bulk-api/account.md) or [Sitelink2 Ad Extension](../bulk-api/sitelink2-ad-extension.md) record.

> [!NOTE]
> [!INCLUDE[pilot_comingsoon](../bulk-api/includes/pilot-comingsoon.md)]
	
## <a name="entitydata"></a>Attribute Fields in the Bulk File
For a *Account Sitelink2 Ad Extension* record, the following attribute fields are available in the [Bulk File Schema](../bulk-api/bulk-file-schema.md). 
...
If you are using the [Bing Ads SDKs](https://msdn.microsoft.com/library/bing-ads-client-libraries.aspx) for .NET, Java, or Python, you can save time using the *BulkServiceManager* to upload and download the *BulkAccountSitelink2AdExtension* class, instead of calling the service operations directly and writing custom code to parse each field in the bulk file. 
