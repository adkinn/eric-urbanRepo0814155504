...
|-----------|---------------|-------------|
|*KeywordLocationResult*|An array of [KeywordLocationResult](../Ad Insight Version 11/keywordlocationresult-data-object.md) data objects. The order of the items corresponds directly to the keywords specified in the request. If there is no location data available for a keyword, the keyword will be included in the list, but the *KeywordLocations* element of the corresponding [KeywordLocationResult](../Ad Insight Version 11/keywordlocationresult-data-object.md) object will be null.<br /><br />Each [KeywordLocationResult](../Ad Insight Version 11/keywordlocationresult-data-object.md) data object contains an array of [KeywordLocation](../Ad Insight Version 11/keywordlocation-data-object.md).  The array contains an item for each device specified in the request. Each [KeywordLocation](../Ad Insight Version 11/keywordlocation-data-object.md) contains the geographical location and percentage of time that users in the geographical location searched for the specified keyword.|[KeywordLocationResult](../Ad Insight Version 11/keywordlocationresult-data-object.md) array|
