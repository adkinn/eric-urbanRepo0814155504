...
|*MatchTypes*|The match types for which you want to get historical data.<br /><br />You may not specify the Content match type.|[MatchType](../Ad Insight Version 11/matchtype-value-set.md) array|Yes|
