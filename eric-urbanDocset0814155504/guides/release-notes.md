...
For more details see the [Keyword Ideas and Traffic Estimates](../guides/keyword-ideas-and-traffic-estimates.md) technical guide.
...
Bing Ads API Version 11 is released to production. For more details, see [Migrating to Bing Ads API Version 11](../guides/migrating-to-bing-ads-api-version-11.md) and [Version 11 API Reference](../guides/version-11-api-reference.md).

[!INCLUDE[v10_sunset](../guides/includes/v10_sunset.md)]

### <a name="sdk_may2017"></a>Bing Ads PHP Software Development Kit (SDK)
The Bing Ads .NET, Java, and PHP SDKs are updated with support for Bing Ads API Version 11 [web service addresses](../guides/bing-ads-web-service-addresses.md). This release enables you to [upgrade](../guides/migrating-to-bing-ads-api-version-11.md) existing features from version 9 and 10 to version 11. 
...
A preview of the Bing Ads API Version 11 is released to sandbox. For more details, see [Migrating to Bing Ads API Version 11](../guides/migrating-to-bing-ads-api-version-11.md) and [Version 11 API Reference](../guides/version-11-api-reference.md).

### <a name="php_sdk_april2017"></a>Bing Ads PHP Software Development Kit (SDK)
The Bing Ads PHP SDK is now available. 

For details please see the [blog post](https://blogs.msdn.microsoft.com/bing_ads_api/2017/04/05/announcing-bing-ads-php-sdk/) and [Getting Started Using PHP with Bing Ads Services](../guides/getting-started-using-php-with-bing-ads-services.md).
