...
3.  Within the BingAdsDesktopApp project, install the SDK through NuGet. For more information, see [Installing the SDK](../guides/getting-started-using-csharp-with-bing-ads-services.md#installation).
