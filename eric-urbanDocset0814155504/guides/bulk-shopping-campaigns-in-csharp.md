...
The following example shows how to apply product conditions for Bing Shopping Campaigns using the *BulkServiceManager* class provided with the [Bing Ads Client Libraries](../guides/bing-ads-client-libraries.md).
