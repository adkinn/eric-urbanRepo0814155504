...
The topics below contain lists of currency, language, time zone, and location strings that can be used for [!INCLUDE[brand](../guides/includes/brand.md)] services. You should refer to the corresponding documentation for usage with service operations and data objects.
...
|[Currencies](../guides/currencies.md)|Contains a list of available currencies for [!INCLUDE[brand](../guides/includes/brand.md)] advertising accounts.|
