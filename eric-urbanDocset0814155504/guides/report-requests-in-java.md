...
The following code example shows how to request and retrieve a keyword performance report using the *ReportingServiceManager* class provided with the [Bing Ads Client Libraries](../guides/bing-ads-client-libraries.md).

[!INCLUDE[java_header](../guides/includes/java_header.md)]
