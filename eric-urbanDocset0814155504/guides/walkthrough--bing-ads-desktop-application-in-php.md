...
For more information about getting started with PHP, please see [Setting Up the Development Environment](../guides/getting-started-using-php-with-bing-ads-services.md#requirements). 
...
2.  Navigate to your local project directory e.g. *c:\dev\BingAdsPHP* and [install](../guides/get-started-using-php-with-bing-ads-services.md#installation) the Bing Ads PHP SDK. You should now see the vendor directory which contains both the SDK source and samples. 
