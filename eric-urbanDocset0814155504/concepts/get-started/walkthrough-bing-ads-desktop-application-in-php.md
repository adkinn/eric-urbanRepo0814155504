...
For more information about getting started with PHP, please see [Setting Up the Development Environment](../../concepts/get-started/getting-started-using-php-with-bing-ads-services.md#requirements). 
...
3.  Copy both *AuthHelper.php* and the *V11* directory (with included samples) to your local project directory e.g. copy from *c:\dev\BingAdsPHP\vendor\microsoft\bingads\samples* to *c:\dev\BingAdsPHP*.
    ...
    ![Sample PHP Project Directory](../../concepts/get-started/media/sample-php-project-directory.PNG)  
    > [!NOTE]
