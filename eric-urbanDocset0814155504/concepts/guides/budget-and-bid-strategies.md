...
> 
> Also note that you must have conversion tracking (a UET tag and a conversion goal) set up for the *EnhancedCpc*, *MaxConversions*, and *TargetCpa* bid strategy types to work. See [Universal Event Tracking](../../concepts/guides/universal-event-tracking.md) for more information.
> 
...
To reduce the chance of irrelevant ads being served to users and the quality score of those ads being affected due to low CTR, you can add any irrelevant queries to your list of negative keywords. To determine the irrelevant queries, see the [Report Types](../../concepts/guides/report-types.md).
...
-   For keywords that you don't want leading to clicks, add them to your keyword list as negative keywords. For more information, see [Negative Keywords](../../concepts/guides/negative-keywords.md).  
...
You can also use negative keywords to prevent you ads from being served if the user’s search query contains one of your negative keywords. For more information about negative keywords, see [Negative Keywords](../../concepts/guides/negative-keywords.md).
