...
The following example shows how to migrate from targets to criterions using the *BulkServiceManager* class provided with the [Bing Ads Client Libraries](../docset-overview/bing-ads-client-libraries.md).
