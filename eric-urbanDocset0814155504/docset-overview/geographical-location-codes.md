...
|---------------|---------------|
|ID|The unique [!INCLUDE[brand](../docset-overview/includes/brand.md)] system identifier for the location.|
...
|AdWords Location ID|The *Google AdWords*Location Criterion Id corresponding to the [!INCLUDE[brand](../docset-overview/includes/brand.md)] geographical location code. You can use this for mapping [!INCLUDE[brand](../docset-overview/includes/brand.md)] locations to the estimated AdWords locations.<br /><br />**Note:** This value is a heuristic estimate that can be used for mapping AdWords and [!INCLUDE[brand](../docset-overview/includes/brand.md)] geographical locations.|
