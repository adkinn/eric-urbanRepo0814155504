...
At a high level you should complete the following steps to authenticate a Microsoft Account with [!INCLUDE[brand](../docset-overview/includes/brand.md)] using OAuth.
