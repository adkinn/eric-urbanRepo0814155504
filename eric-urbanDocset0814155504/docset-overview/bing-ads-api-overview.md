...
|[Release Notes](../docset-overview/release-notes.md)|Stay informed about the changes to the [!INCLUDE[brand](../docset-overview/includes/brand.md)] services for each release.|
