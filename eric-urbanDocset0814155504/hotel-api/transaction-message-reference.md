...
For information about creating a transaction message, see [Creating a Transaction Message](../hotel-api/creating-a-transaction-message.md).

For information about sending a transaction message, see [Sending a Transaction Message](../hotel-api/sending-bing-transaction-messages.md).
