...
The following example shows how to add targets using the *BulkServiceManager* class provided with the [Bing Ads Client Libraries](../docset-overview/bing-ads-client-libraries.md).
