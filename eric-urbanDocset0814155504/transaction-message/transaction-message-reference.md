...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 19ca739b-8cb2-408b-8539-d16bb8260005
...
For information about creating a transaction message, see [Creating a Transaction Message](../transaction-message/creating-a-transaction-message.md).

For information about sending a transaction message, see [Sending a Transaction Message](../transaction-message/sending-bing-transaction-messages.md).
