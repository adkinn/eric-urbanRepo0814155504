---
title: "sending copy with 429 case"
ms.custom: ""
ms.date: "08/01/2017"
ms.reviewer: ""
ms.suite: ""
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 0c6b99af-b91f-4508-8808-1574b71e4fd9
caps.latest.revision: 2
author: "eric-urban"
ms.author: "scottwhi"
---
# sending copy with 429 case
Before sending a transaction message:

- Validate the message to ensure that it's compliant with the [Transaction XSD](../Topic/Transaction%20XSD.md). This will save you round trips and time having to fix errors.
...
- Ensure that you send less than five requests per second (QPS). Your application should include the logic necessary to stay within the limit. If you exceed QPS, the request fails with HTTP status code 429. 
...
If the request succeeds (the message is successfully placed in the queue), the response's body includes an XML document that specifies the number of bytes read from the request's body (the transaction message). 
