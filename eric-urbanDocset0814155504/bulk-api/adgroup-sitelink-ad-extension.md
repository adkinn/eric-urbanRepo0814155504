...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 6051108e-6fb4-4912-9790-cfd94bc151be
...
Defines an association record between an [Ad Group](../bulk-api/ad-group.md) and a [Sitelink Ad Extension](../bulk-api/sitelink-ad-extension.md) that can be uploaded and downloaded in a bulk file. To upload or download the ad group or sitelink ad extension, use the [Ad Group](../bulk-api/ad-group.md) or [Sitelink Ad Extension](../bulk-api/sitelink-ad-extension.md) record. 

> [!IMPORTANT]
> [!INCLUDE[sitelinks_migration_eta](../bulk-api/includes/sitelinks-migration-eta.md)]   
	
## <a name="entitydata"></a>Attribute Fields in the Bulk File
For an *AdGroup Sitelink Ad Extension* record, the following attribute fields are available in the [Bulk File Schema](../bulk-api/bulk-file-schema.md). 
...
If you are using the [Bing Ads SDKs](https://msdn.microsoft.com/library/bing-ads-client-libraries.aspx) for .NET, Java, or Python, you can save time using the *BulkServiceManager* to upload and download the *BulkAdGroupSiteLinkAdExtension* class, instead of calling the service operations directly and writing custom code to parse each field in the bulk file. 
