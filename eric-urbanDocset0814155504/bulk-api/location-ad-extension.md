...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 49d9c862-4052-4dfc-af22-d8a8311985df
...
For a *Location Ad Extension* record, the following attribute fields are available in the [Bulk File Schema](../bulk-api/bulk-file-schema.md). 
...
**Add:** Optional  
**Update:** [!INCLUDE[update_optional_setting_deleted](../bulk-api/includes/update-optional-setting-deleted.md)]    
**Delete:** Read-only  
