...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: 50837890-5270-4d0a-9461-01c2ed0d71f4
...
Defines an association record between an [Ad Group](../bulk-api/ad-group.md) and a [Structured Snippet Ad Extension](../bulk-api/structured-snippet-ad-extension.md) that can be uploaded and downloaded in a bulk file. To upload or download the ad group or structured snippet ad extension, use the [Ad Group](../bulk-api/ad-group.md) or [Structured Snippet Ad Extension](../bulk-api/structured-snippet-ad-extension.md) record.
	
## <a name="entitydata"></a>Attribute Fields in the Bulk File
For an *Ad Group Structured Snippet Ad Extension* record, the following attribute fields are available in the [Bulk File Schema](../bulk-api/bulk-file-schema.md). 
...
If you are using the [Bing Ads SDKs](https://msdn.microsoft.com/library/bing-ads-client-libraries.aspx) for .NET, Java, or Python, you can save time using the *BulkServiceManager* to upload and download the *BulkAdGroupStructuredSnippetAdExtension* class, instead of calling the service operations directly and writing custom code to parse each field in the bulk file. 
