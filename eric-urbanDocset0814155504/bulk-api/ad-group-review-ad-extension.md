...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: d5236ae8-453a-44cb-b818-b9bf41425cba
...
Defines an association record between an [Ad Group](../bulk-api/ad-group.md) and a [Review Ad Extension](../bulk-api/review-ad-extension.md) that can be uploaded and downloaded in a bulk file. To upload or download the ad group or review ad extension, use the [Ad Group](../bulk-api/ad-group.md) or [Review Ad Extension](../bulk-api/review-ad-extension.md) record.
	
## <a name="entitydata"></a>Attribute Fields in the Bulk File
For an *Ad Group Review Ad Extension* record, the following attribute fields are available in the [Bulk File Schema](../bulk-api/bulk-file-schema.md). 
...
If you are using the [Bing Ads SDKs](https://msdn.microsoft.com/library/bing-ads-client-libraries.aspx) for .NET, Java, or Python, you can save time using the *BulkServiceManager* to upload and download the *BulkAdGroupReviewAdExtension* class, instead of calling the service operations directly and writing custom code to parse each field in the bulk file. 
