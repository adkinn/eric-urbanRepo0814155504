...
The following example shows how to add and update ad extensions using the *BulkServiceManager* class provided with the [Bing Ads Client Libraries](../guides/bing-ads-client-libraries.md).
