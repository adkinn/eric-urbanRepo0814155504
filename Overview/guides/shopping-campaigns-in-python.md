...
This example shows how to apply product conditions for [!INCLUDE[brand_bsc](../guides/includes/brand_bsc.md)] using the following Campaign Management service operations.
